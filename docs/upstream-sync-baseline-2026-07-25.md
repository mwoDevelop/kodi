# Upstream sync implementation baseline
...
The root repository was clean except for the newly prepared
`UPSTREAM_SYNC_PLAN.md` and its independent review.

No branch protection or repository ruleset was enabled on any of the four
repositories at capture time.

## Channel locks

Stable and testing pointed at the same component commits and bytes:

| Add-on | Version | ZIP SHA-256 |
|---|---:|---|
...
- downloaded public `artifact-manifest.sha256` file SHA-256:
  `2e5049c96a192bfb3041e99087b046c21ee72ec8338442a72a3241dc14d7b7df`.

The latest root repository test and testing publication runs for
`8ec6410b901cb3c76043cc13b24b7463488ec70d` completed successfully.
...
- Model: `SM-S901E`
- Kodi: `21.3`
- Kodi process was running.

Installed mwoDevelop add-ons:

| Add-on | Version | Kodi `installed.origin` |
|---|---:|---|
...
`repository.mwodevelop.testing` was not installed.

This is the recovery and comparison point for the post-implementation
BlueStacks E2E.
